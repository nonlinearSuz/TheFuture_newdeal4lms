				...
				<ul>
					...
					<li class="contents">
						...
						<div class="content">
							...
							<a href="" class="btnType blue" id="btnApprovalSearch" name="btn"><span> 수강</span></a>
							 <a href="" class="btnType blue" id="btnUnapprovalSearch" name="btn"><span>미수강</span></a> 
							 <span style="margin-left: 275px;"></span> 가입일 조회 
							 <input type="date" id="startDate" th:field="*{start}"style="height: 30px; width: 150px;"> ~ 
							 <input type="date" id="endDate" th:field="*{end}" style="height: 30px; width: 150px;"> 
							 <span style="margin-left: 10px;"></span> 
							 <a href="" class="btnType blue" id="btnView" name="btn" style="margin-bottom: 10px;"><span>조회</span></a>
